...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllByState(Long bookerId, String state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getAllByOwnerAndState(Long bookerId, String state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size);
